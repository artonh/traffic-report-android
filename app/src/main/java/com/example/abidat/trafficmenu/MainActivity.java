...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        else if (id == R.id.nav_aboutApp) { /// hapet nje intent per about
            Intent Rreth = new Intent(MainActivity.this, RrethNesh.class);
            startActivity(Rreth);
        }
        else if (id == R.id.nav_share) {
            //me ba Share te mundeshme ne rrjete sociale apo edhe komunikim tjeter ne mobile
        }
        else if (id == R.id.nav_send) {
            //dergimi permes messenger, viber
        }
